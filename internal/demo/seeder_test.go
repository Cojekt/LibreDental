...
func TestSeedDatabase(t *testing.T) {
	...
	if summary.AppointmentsCount != 20 {
		t.Errorf("Expected 20 appointments, got %d", summary.AppointmentsCount)
	}
	...
	if len(appts) != 20 {
		t.Errorf("Expected 20 appointments in list, got %d", len(appts))
	}
