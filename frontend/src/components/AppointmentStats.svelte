...
<div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
  <!-- Scheduled -->
  <div
    class="rounded-xl border border-slate-700/80 bg-slate-800/80 p-3.5 shadow-sm backdrop-blur"
  >
    <div
  ...
  >
    <div
      class="flex items-center justify-between text-xs font-semibold text-sky-400"
    >
  ...
  <!-- Arrived / Waiting -->
  <div
    class="rounded-xl border border-amber-500/30 bg-amber-500/10 p-3.5 shadow-sm backdrop-blur"
  >
    <div
      class="flex items-center justify-between text-xs font-semibold text-amber-400"
    >
  ...
  >
    <div
      class="flex items-center justify-between text-xs font-semibold text-purple-400"
    >
  ...
  >
    <div
      class="flex items-center justify-between text-xs font-semibold text-emerald-400"
    >
