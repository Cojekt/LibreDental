	...
	appointments := []*domain.Appointment{
		{
			...
			ProviderID:  "prov_101",
			OperatoryID: "op_1",
			StartTime:   mkTime(yesterday, 9, 0),
			EndTime:     mkTime(yesterday, 10, 0),
		...
		},
		{
			...
			ProviderID:  "prov_103",
			OperatoryID: "op_2",
			StartTime:   mkTime(yesterday, 11, 0),
		...
		},
		{
			...
			ProviderID:  "prov_102",
			OperatoryID: "op_3",
			StartTime:   mkTime(today, 8, 30),
			EndTime:     mkTime(today, 9, 30),
			Status:      domain.AppointmentStatusComplete,
		...
		},
		{
			...
			ProviderID:  "prov_103",
			OperatoryID: "op_2",
			StartTime:   mkTime(today, 13, 0),
			EndTime:     mkTime(today, 14, 0),
		...
		},
		{
			...
			Color:       "#10b981",
			Notes:       "In-office vs take-home tray comparison.",
			CreatedAt:   now,
			UpdatedAt:   now,
			Version:     1,
		},
